...
namespace DistributedServicesCW {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Username, string Password, string Email, string First_Name, string Last_Name) {
...
namespace DistributedServicesCW.LoginDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Login] ([Username], [Password], [Email], [First_Name], [Last_N" +
                "ame]) VALUES (@Username, @Password, @Email, @First_Name, @Last_Name);\r\nSELECT Us" +
                "ername, Password, Email, First_Name, Last_Name FROM Login WHERE (Username = @Use" +
                "rname)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [Username] = @Username, [Password] = @Password, [Email] = @Email, [First_Name] = @First_Name, [Last_Name] = @Last_Name WHERE (([Username] = @Original_Username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)));
SELECT Username, Password, Email, First_Name, Last_Name FROM Login WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DistributedServicesCW.Properties.Settings.Default.LoginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Email, First_Name, Last_Name FROM dbo.Login";
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Username] = @Original_Username) AND ([Email] =" +
                " @Original_Email) AND ([First_Name] = @Original_First_Name))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Username", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Username] = @Username, [Password] = @Password, [Email] = @Email, [First_Name] = @First_Name, [Last_Name] = @Last_Name WHERE (([Username] = @Original_Username) AND ([Email] = @Original_Email) AND ([First_Name] = @Original_First_Name));
SELECT Username, Password, Email, First_Name, Last_Name FROM [Table] WHERE (Username = @Username)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_Username, string Original_Email, string Original_First_Name) {
            if ((Original_Username == null)) {
                throw new global::System.ArgumentNullException("Original_Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Email, string First_Name, string Last_Name, string Original_Username, string Original_Email, string Original_First_Name) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Email, string First_Name, string Last_Name, string Original_Username, string Original_Email, string Original_First_Name) {
            return this.Update(Original_Username, Password, Email, First_Name, Last_Name, Original_Username, Original_Email, Original_First_Name);
        }
    }
