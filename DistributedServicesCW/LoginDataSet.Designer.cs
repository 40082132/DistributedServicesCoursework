...
namespace DistributedServicesCW {
    ...
    public partial class LoginDataSet : global::System.Data.DataSet {
        ...
        public partial class LoginsDataTable : global::System.Data.TypedTableBase<LoginsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public LoginsRow AddLoginsRow(string Username, string Password, string Email, string First_Name, string Last_Name) {
        ...
        public partial class LoginsRow : global::System.Data.DataRow {
            ...
            public string Last_Name {
                get {
                    return ((string)(this[this.tableLogins.Last_NameColumn]));
                }
                set {
                    this[this.tableLogins.Last_NameColumn] = value;
                }
            }
        }
    ...
    public partial class LoginsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Logins] WHERE (([Username] = @Original_Username) AND ([Passwor" +
                "d] = @Original_Password) AND ([Email] = @Original_Email) AND ([First_Name] = @Or" +
                "iginal_First_Name) AND ([Last_Name] = @Original_Last_Name))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Logins] ([Username], [Password], [Email], [First_Name], [Last_" +
                "Name]) VALUES (@Username, @Password, @Email, @First_Name, @Last_Name);\r\nSELECT U" +
                "sername, Password, Email, First_Name, Last_Name FROM Logins WHERE (Username = @U" +
                "sername)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Logins] SET [Username] = @Username, [Password] = @Password, [Email] = @Email, [First_Name] = @First_Name, [Last_Name] = @Last_Name WHERE (([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Email] = @Original_Email) AND ([First_Name] = @Original_First_Name) AND ([Last_Name] = @Original_Last_Name));
SELECT Username, Password, Email, First_Name, Last_Name FROM Logins WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DistributedServicesCW.Properties.Settings.Default.LoginDataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Email, First_Name, Last_Name FROM dbo.Logins";
        ...
        public virtual int Fill(LoginDataSet.LoginsDataTable dataTable) {
        ...
        public virtual LoginDataSet.LoginsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDataSet.LoginsDataTable dataTable = new LoginDataSet.LoginsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDataSet.LoginsDataTable dataTable) {
